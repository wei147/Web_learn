...
```java
1.先安装nodejs   	(node -v  查看nodejs的版本)
2.安装npm (和nodejs应该是一起安装的, npm -v   npm:node package mange nodejs 包管理器)
3.npm install nrm -g  (nrm可以选择国内源下载?)
4.nrm use taobao

C:\Users\w1216>nrm ls
...
安装vue脚手架工具
    1.npm uninstall vue-cli -g  ||  yarn global remove vue-cli (如果有的话,卸载vue脚手架工具)
